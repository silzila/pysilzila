...
export const BuildTable = ({ crossTabData, dustbinRows, dustbinValues, dustbinColumns, chartPropData, chartProp, propKey }) => {
  const [showPopup, setShowPopup] = useState(false);
  const [popupData, setPopupData] = useState({});

  const [userClickedCell, serUserClickedCell] = useState(chartProp.properties[propKey].crossTabUserClicked);
