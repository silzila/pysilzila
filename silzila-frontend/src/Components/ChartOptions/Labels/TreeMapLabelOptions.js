	...
	return (
		<React.Fragment>
			...
			<FormControl fullWidth size="small" style={{ fontSize: "12px", borderRadius: "4px" }}>
				<Select
					value={chartProp.properties[propKey].treeMapChartControls.labelPosition}
					variant="outlined"
					onChange={(e) => {
			...
			<FormControl fullWidth size="small" style={{ fontSize: "12px", borderRadius: "4px" }}>
				<Select
					value={chartProp.properties[propKey].treeMapChartControls.labelRotate}
					variant="outlined"
					onChange={(e) => {
			...
			<FormControl fullWidth size="small" style={{ fontSize: "12px", borderRadius: "4px" }}>
				<Select
					value={chartProp.properties[propKey].treeMapChartControls.overFlow}
					variant="outlined"
					onChange={(e) => {
			...
			<FormControl fullWidth size="small" style={{ fontSize: "12px", borderRadius: "4px" }}>
				<Select
					value={chartProp.properties[propKey].treeMapChartControls.horizondalAlign}
					variant="outlined"
					onChange={(e) => {
			...
			<FormControl fullWidth size="small" style={{ fontSize: "12px", borderRadius: "4px" }}>
				<Select
					value={chartProp.properties[propKey].treeMapChartControls.verticleAlign}
					variant="outlined"
					onChange={(e) => {
